...
<div class="modal-dialog" style="margin-top: 10%;width: 400px;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title text-center" id="myModalLabel" style="font-family: 楷体;">生产线信息更新</h2>
        </div>
        <form action="${pageContext.request.contextPath}/update_producer" method="post" onsubmit="return check()">
                ...
                <tr>
                    ...
                    <td width="60%">
                        <div style="margin-bottom:10px;padding-top:30px;">
                            <input class="easyui-textbox" type="text" name="id" id="id"  placeholder="Id" style="height:30px;padding:12px"
                ...
                <tr>
                    ...
                    <td width="60%">
                        <div style="margin-bottom:10px">
                            <input class="easyui-textbox" type="text" name="workshopNo" id="workshopNo" placeholder="WorkshopNo" style="height:30px;padding:12px"
                                   data-options="prompt:'车间编号',iconWidth:38" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%">
                        <div style="margin-bottom:10px">
                            <input class="easyui-textbox" type="text" name="producerNo" id="producerNo" placeholder="ProducerNo" style="height:30px;padding:12px"
                                   data-options="prompt:'生产线编号',iconWidth:38" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="60%">
                        <select class="easyui-combobox" type="text" name="status" id="status" placeholder="Status" style="height:30px;padding:12px;width:100%;"
                                   data-options="prompt:'生产线状态',iconWidth:38"/>
